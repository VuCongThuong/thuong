...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#about">Giới Thiệu</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#skills">Kỹ Năng</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#awards">Học Vấn</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#contact">Liên Lạc</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="index.php">English</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    ======================================================-->
        <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
            <div class="my-auto">
                ...
                <h1 class="mb-0">Vũ Công
                    <span class="text-primary">Thưởng</span>
                </h1>
    ...
    ======================================================-->
        <section class="resume-section p-3 p-lg-5 " id="experience">
            <div class="row my-auto">
                <div class="col-12">
                    <h2 class="  text-center">Kinh Nghiệm</h2>
                    <div class="mb-5 heading-border"></div>
                </div>
                <div class="resume-item col-md-6 col-sm-12 ">
                    <div class="card mx-0 p-4 mb-5" style="border-color: #17a2b8; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                        <div class=" resume-content mr-auto">
                            <h4 class="mb-3"><i class="fa fa-globe mr-3 text-info"></i> Nhân Viên Kinh Doanh Bất Động Sản</h4>
                            <p>Sau 1 năm làm việc cho công ty BĐS Beegreen với dự án Sala Garden. Tôi học được tính kiên nhẫn, tỉ mỉ và đặc biệt tôi có thêm kinh nghiệm về kỹ năng tạo mối quan hệ, kỹ năng giao tiếp, quan sát và khả năng chịu áp lực cao.
                            </p>
                        </div>
                        <div class="resume-date text-md-right">
                            <span class="text-primary">Tháng 3, 2018 - Tháng 2, 2019 </span>
                        </div>
                    </div>
                </div>
                <div class="resume-item col-md-6 col-sm-12">
                    <div class="card mx-0 p-4 mb-5" style="border-color: #ffc107; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                        <div class="resume-content mr-auto">
                            <h4 class="mb-3"><i class="fa fa-laptop mr-3 text-warning"></i> Bổ Sung Kỹ Năng Mềm</h4>
                            <p>Vinh hạnh được đào tạo Sĩ Quan Dự Bị cho địa phương, những kỹ năng như giải quyết vấn đề, tính đúng giờ, làm việc nhóm và khả năng thích ứng là không thể thiếu. Tôi tin rằng, với những tính cách và kỹ năng được rèn luyện này sẽ giúp ích cho tôi trong công việc.
                            </p>
                        </div>
                        <div class="resume-date text-md-right">
                            <span class="text-primary">Tháng 2, 2019 - Tháng 5, 2021</span>
                        </div>
                    </div>
                </div>
                <div class="resume-item col-md-6 col-sm-12">
                    <div class="card mx-0 p-4 mb-5" style="border-color: #28a745; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                        <div class="resume-content mr-auto">
                            <h4 class="mb-3"><i class="fa fa-camera mr-3 text-success"></i> Lập Trình Viên Website</h4>
                            <p>Trong đại dịch Covid-19. Với niềm đam mê công nghệ, tôi đã không ngừng học hỏi qua các khóa học trực tuyến với mong muốn trở thành một lập trình viên website chuyên nghiệp.</p>
                        </div>
                        <div class="resume-date text-md-right">
                            <span class="text-primary">6 2021 - Hiện tại</span>
                        </div>
                    </div>
                </div>
                <!-- <div class="resume-item col-md-6 col-sm-12">
    ...
    ======================================================-->
        <section class=" d-flex flex-column" id="skills">
            <div class="p-lg-5 p-3 skill-cover">
                <h3 class="text-center text-white">Kỹ Năng Viết Code</h3>
                <div class="row text-center my-auto ">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="skill-item">
                            ...
                            <h2><span class="counter"> 53 </span><span>%</span></h2>
                            <p>CSS3</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
    ...
    ======================================================-->
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="awards">
            <div class="row my-auto">
                <div class="col-12">
                    <h2 class="  text-center">Học Vấn</h2>
                    <div class="mb-5 heading-border"></div>
                </div>
                <div class="main-award" id="award-box">
                    <div class="award">
                        ...
                        <div class="award-content">
                            <span class="date">Tháng 4, 2015 - Tháng 3, 2018</span>
                            <h5 class="title">Cao Đẳng</h5>
                            <p class="description">
                            Tốt nghiệp trường Cao đẳng Công nghệ và Quản lý Sonadezi, chuyên ngành Tiếng Anh Thương mại. Nhận chứng chỉ “Đào tạo Khởi sự Doanh nghiệp” năm 2016.                            </p>
                        </div>
                    </div>
                    <div class="award">
                        <div class="award-icon"></div>
                        <div class="award-content">
                            <span class="date">Tháng 2, 2019 - Tháng 5, 2021</span>
                            <h5 class="title">"Trường Đại Học Tổng Hợp"</h5>
                            <p class="description">
                            Học viên Sĩ Quan Dự Bị tại Trường Hạ Sĩ Quan Tăng Xe Tăng 1
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <form id="" action="" method="post">
                        <fieldset>
                            <div class="row con-form">
                                <div class="col-md-12">
                                    <input type="text" name="full-name" placeholder="Họ và Tên" class="form-control">
                                    <?php if(isset($errors) && in_array('full-name',$errors)) { echo "<span style='color:red;'>Please enter your full name.</span>";}?>
                                </div>
                                <div class="col-md-12">
                                    <input type="text" name="email" placeholder="Email " class="form-control">
                                    <?php if(isset($errors) && in_array('email',$errors)) { echo "<span style='color:red;'>Please enter your last name.</span>";}?>
                                </div>
                                <div class="col-md-12">
                                    <input type="text" name="subject" placeholder="Tiêu đề" class="form-control">
                                    <?php if(isset($errors) && in_array('subject',$errors)) { echo "<span style='color:red;'>Please enter your last name.</span>";}?>
                                </div>
                                <div class="col-md-12"><textarea name="content" id=""></textarea></div>
                                <?php if(isset($errors) && in_array('content',$errors)) { echo "<span style='color:red;'>Please enter your last name.</span>";}?>
                            </div>
                        </fieldset>
                                <div class="col-md-12 sub-but"><button class="btn btn-general btn-white" role="button">Gửi</button></div>
                    </form>
                        ...
                        if(!empty($_POST)) { 
                            $errors = array();
                            if(isset($_POST['full-name']) && preg_match('/^[\w\'.-]{2,20}$/i', trim($_POST['full-name']))) {
                                $fn = $_POST['full-name'];
                            }else $errors[] ='full-name';

                            if(isset($_POST['email']) && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
                                $e = $_POST['email'];
                            }else $errors[] ='email'; 
                            
                            if(isset($_POST['subject']) && preg_match('/^[\w\'.-]{2,20}$/i', trim($_POST['subject']))) {
                                $s = $_POST['subject'];
                            }else $errors[] ='subject'; 
                            ...
                            if(empty($errors)){
                                try {
                                    ...
                                    $mail->Username = 'congthuong147@gmail.com';                 // SMTP username
                                    $mail->Password = 'Congthuong123@';                           // SMTP password
                                    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
                                    $mail->Port = 587;                                    // TCP port to connect to
                                
                                    //Recipients
                                    $mail->setFrom('congthuong147@gmail.com', '');
                                    $mail->addAddress('congthuong147@gmail.com', '');     // Add a recipient
                                    ...
                                    $mail->Subject = $s;
                                    $mail->Body    = 'Form: '. $fn .': ' . $e.'<p></p>'.$c;
                                    $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
                                
                                    $mail->send();
                                    echo '<p style="color:green; font-size:300%;">Message has been sent</p>';
                                } catch (Exception $e) {
                                    echo '<p style="color:red; font-size:300%;"Message could not be sent</p>';
                                }
                            }
                        }
                        ?>
                ...
                <div class="col-md-4 col-sm-12 mt-5">
                    <div class="contact-cont2">
                        <div class="contact-add contact-box-desc">
                            <h3><i class="fa fa-map-marker cl-atlantis fa-2x"></i> Địa chỉ</h3>
                            <p>352 tổ 8, ấp Long Phú, xã Phước Thái, huyện Long Thành, tỉnh Đồng Nai.</p>
                        </div>
                        <div class="contact-phone contact-side-desc contact-box-desc">
                            <h3><i class="fa fa-phone cl-atlantis fa-2x"></i> Số điện thoại</h3>
                            <p>0968 796 664<br></p>
                        </div>
                        <div class="contact-mail contact-side-desc contact-box-desc">
                            <h3><i class="fa fa-envelope-o cl-atlantis fa-2x"></i> Email</h3>
                            <address class="address-details-f"> 
                  Email: <a href="congthuong147.com" class="">congthuong147@gmail.com</a>
                </address>
        ...
        <section class=" d-flex flex-column" id="maps">
            <div id="map">
                <div class="map-responsive">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62731.357751865915!2d106.9830910003986!3d10.679614001068371!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317510a8af31b1bd%3A0xe73ff126a0246885!2zUGjGsOG7m2MgVGjDoWksIExvbmcgVGjDoG5oLCDEkOG7k25nIE5haQ!5e0!3m2!1svi!2s!4v1633254166649!5m2!1svi!2s"
