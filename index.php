    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="index1.php">Vietnamese</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    ======================================================-->
        <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
            <div class="my-auto">
                ...
                <h1 class="mb-0">Vu Cong
                    <span class="text-primary">Thuong</span>
                </h1>
                ...
                <div class="resume-item col-md-6 col-sm-12 ">
                    <div class="card mx-0 p-4 mb-5" style="border-color: #17a2b8; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                        <div class=" resume-content mr-auto">
                            <h4 class="mb-3"><i class="fa fa-globe mr-3 text-info"></i> Real Estate Salesperson</h4>
                            <p>After graduating from college, I worked for Beegreen company for 1 year. Through this job, I learned to be patient and meticulous and especially I have more experience in interpersonal skills, communication skills, observation,
                                and high pressure tolerance.
                            </p>
                        </div>
                        <div class="resume-date text-md-right">
                            <span class="text-primary">March 2018 - February 2019 </span>
                        </div>
                    </div>
                </div>
                <div class="resume-item col-md-6 col-sm-12">
                ...
                <div class="main-award" id="award-box">
                    <div class="award">
                        ...
                        <div class="award-content">
                            <span class="date">Apr 2015 - Mar 2018</span>
                            <h5 class="title">College</h5>
                            <p class="description">
                                Graduated from Sonadezi College Of Technology And Management, majoring in Business English. Received a "Business Start-up Training" certificate in 2016.
                            </p>
                        </div>
                    </div>
                    <div class="award">
                ...
                <div class="col-md-4 col-sm-12 mt-5">
                    <div class="contact-cont2">
                        <div class="contact-add contact-box-desc">
                            ...
                            <p>No 352/Gourp 8, Long Phu hamlet, Phuoc Thai commune, Long Thanh District, Dong Nai province.</p>
                        </div>
